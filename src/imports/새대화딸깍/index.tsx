import svgPaths from "./svg-yz49hawimu";
    ...
    <div className="relative shrink-0 w-full" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[#4f7bff] text-[38px] text-center tracking-[-1.9px] whitespace-nowrap">
          <span className="leading-[47.5px]">딸깍</span>
          <span className="leading-[47.5px] text-[#0a0a0a]">{` 한 번이면, 작업은 더 빠르게`}</span>
        </p>
      </div>
    </div>
  );
...
function Paragraph() {
  return (
    <div className="h-[38px] relative shrink-0 w-[444.438px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center pt-[14px] relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[23.563px] relative shrink-0 text-[#737373] text-[14.5px] text-center tracking-[-0.3625px] whitespace-nowrap">이미지, 문서, 발표자료, 검수까지 필요한 AI 작업을 한 곳에서.</p>
      </div>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="h-[126px] max-w-[768px] relative shrink-0 w-[444.438px]" data-name="Container">
...
function TextArea() {
  return (
    <div className="bg-[rgba(255,255,255,0)] flex-[148_0_0] max-h-[306.3999938964844px] min-h-[148px] relative w-[834px]" data-name="Text Area">
...
function Container11() {
  return (
    <div className="relative shrink-0 w-[834px]" data-name="Container">
...
function Button5() {
  return (
    <div className="absolute left-[795px] rounded-[16777200px] size-[28px] top-[11px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Icon5 />
      </div>
    </div>
...
function Container9() {
  return (
    <div className="bg-white h-[216px] relative rounded-[22px] shrink-0 w-[840px]" data-name="Container">
...
function Container7() {
  return (
    <div className="max-w-[840px] relative shrink-0 w-[840px]" data-name="Container">
...
function Container6() {
  return (
    <div className="relative shrink-0 w-[1068px]" data-name="Container">
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p11d16a80} id="Vector" stroke="var(--stroke-0, #F59E0B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d={svgPaths.p1b53d300} id="Vector_2" stroke="var(--stroke-0, #F59E0B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d={svgPaths.p1c7c380} id="Vector_3" stroke="var(--stroke-0, #F59E0B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
        </g>
      </svg>
    </div>
  );
...
function Text2() {
  return (
    <div className="bg-[#f1f5f9] drop-shadow-[0px_4px_6px_rgba(0,0,0,0.04)] relative rounded-[16777200px] shrink-0 size-[64px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Icon6 />
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0" data-name="Text:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[12px] relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[20.25px] relative shrink-0 text-[#334155] text-[13.5px] text-center tracking-[-0.3375px] whitespace-nowrap">이미지</p>
      </div>
    </div>
  );
}
...
function Icon7() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p111d5080} id="Vector" stroke="var(--stroke-0, #22C55E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d={svgPaths.p2ca2ecb0} id="Vector_2" stroke="var(--stroke-0, #22C55E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d={svgPaths.p3a313e00} id="Vector_3" stroke="var(--stroke-0, #22C55E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
        </g>
      </svg>
    </div>
  );
...
function TextMargin1() {
  return (
    <div className="relative shrink-0" data-name="Text:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[12px] relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[20.25px] relative shrink-0 text-[#334155] text-[13.5px] text-center tracking-[-0.3375px] whitespace-nowrap">랜딩페이지</p>
      </div>
    </div>
  );
}
...
function Icon8() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p30fea100} id="Vector" stroke="var(--stroke-0, #EF4444)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d="M6.2 5.3L9.3 9.2" id="Vector_2" stroke="var(--stroke-0, #EF4444)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d="M12.4 3.4L15.5 7.4" id="Vector_3" stroke="var(--stroke-0, #EF4444)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d={svgPaths.p1ae59200} id="Vector_4" stroke="var(--stroke-0, #EF4444)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
        </g>
      </svg>
    </div>
  );
...
function TextMargin2() {
  return (
    <div className="relative shrink-0" data-name="Text:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[12px] relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[20.25px] relative shrink-0 text-[#334155] text-[13.5px] text-center tracking-[-0.3375px] whitespace-nowrap">동영상</p>
      </div>
    </div>
  );
}
...
function Icon9() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d="M2 3H22" id="Vector" stroke="var(--stroke-0, #8B5CF6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d={svgPaths.p21109e00} id="Vector_2" stroke="var(--stroke-0, #8B5CF6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d="M7 21L12 16L17 21" id="Vector_3" stroke="var(--stroke-0, #8B5CF6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
        </g>
      </svg>
    </div>
  );
...
function TextMargin3() {
  return (
    <div className="relative shrink-0" data-name="Text:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[12px] relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[20.25px] relative shrink-0 text-[#334155] text-[13.5px] text-center tracking-[-0.3375px] whitespace-nowrap">프레젠테이션</p>
      </div>
    </div>
  );
}
...
function Icon10() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d="M2 10V13" id="Vector" stroke="var(--stroke-0, #D946EF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d="M6 6V17" id="Vector_2" stroke="var(--stroke-0, #D946EF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d="M10 3V21" id="Vector_3" stroke="var(--stroke-0, #D946EF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d="M14 8V15" id="Vector_4" stroke="var(--stroke-0, #D946EF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d="M18 5V18" id="Vector_5" stroke="var(--stroke-0, #D946EF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d="M22 10V13" id="Vector_6" stroke="var(--stroke-0, #D946EF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
        </g>
      </svg>
    </div>
  );
...
function TextMargin4() {
  return (
    <div className="relative shrink-0" data-name="Text:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[12px] relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[20.25px] relative shrink-0 text-[#334155] text-[13.5px] text-center tracking-[-0.3375px] whitespace-nowrap">오디오</p>
      </div>
    </div>
  );
}
...
function Icon11() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.pb007f00} id="Vector" stroke="var(--stroke-0, #3B82F6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d={svgPaths.p1b58ab00} id="Vector_2" stroke="var(--stroke-0, #3B82F6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d="M10 9H8" id="Vector_3" stroke="var(--stroke-0, #3B82F6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d="M16 13H8" id="Vector_4" stroke="var(--stroke-0, #3B82F6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d="M16 17H8" id="Vector_5" stroke="var(--stroke-0, #3B82F6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
        </g>
      </svg>
    </div>
  );
...
function TextMargin5() {
  return (
    <div className="relative shrink-0" data-name="Text:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[12px] relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[20.25px] relative shrink-0 text-[#334155] text-[13.5px] text-center tracking-[-0.3375px] whitespace-nowrap">문서</p>
      </div>
    </div>
  );
}
...
function Icon12() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p37c73510} id="Vector" stroke="var(--stroke-0, #10B981)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d="M15 5L19 9" id="Vector_2" stroke="var(--stroke-0, #10B981)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
        </g>
      </svg>
    </div>
  );
...
function TextMargin6() {
  return (
    <div className="relative shrink-0" data-name="Text:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[12px] relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[20.25px] relative shrink-0 text-[#334155] text-[13.5px] text-center tracking-[-0.3375px] whitespace-nowrap">서식</p>
      </div>
    </div>
  );
}
...
function Icon13() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.pace200} id="Vector" stroke="var(--stroke-0, #F59E0B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          <path d="M9 12L11 14L15 10" id="Vector_2" stroke="var(--stroke-0, #F59E0B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
        </g>
      </svg>
    </div>
  );
...
function TextMargin7() {
  return (
    <div className="relative shrink-0" data-name="Text:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[12px] relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[20.25px] relative shrink-0 text-[#334155] text-[13.5px] text-center tracking-[-0.3375px] whitespace-nowrap">PPT 검수</p>
      </div>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="h-[121px] max-w-[980px] relative shrink-0 w-[980px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[44px] items-start justify-center max-w-[inherit] pt-[24px] px-[4px] relative size-full">
        <Button6 />
        <Button7 />
        <Button8 />
        <Button9 />
...
function Container5() {
  return (
    <div className="flex-[668_0_0] min-h-px relative w-[1068px]" data-name="Container">
...
function Text10() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[18px] relative shrink-0 text-[12px] text-[rgba(115,115,115,0.7)] text-center tracking-[-0.3px] whitespace-nowrap">딸깍.net · AI 통합 서비스 · © 2026</p>
      </div>
    </div>
  );
}
...
function Text11() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[18px] relative shrink-0 text-[12px] text-[rgba(115,115,115,0.3)] text-center tracking-[-0.3px] whitespace-nowrap">·</p>
      </div>
    </div>
  );
}
...
function Button14() {
  return (
    <div className="relative shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[18px] relative shrink-0 text-[12px] text-[rgba(115,115,115,0.7)] text-center tracking-[-0.3px] whitespace-nowrap">고객센터</p>
      </div>
    </div>
  );
}
...
function Link() {
  return (
    <div className="relative shrink-0" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[18px] relative shrink-0 text-[12px] text-[rgba(115,115,115,0.7)] text-center tracking-[-0.3px] whitespace-nowrap">이용약관</p>
      </div>
    </div>
  );
}
...
function Link1() {
  return (
    <div className="relative shrink-0" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[18px] relative shrink-0 text-[12px] text-[rgba(115,115,115,0.7)] text-center tracking-[-0.3px] whitespace-nowrap">개인정보처리방침</p>
      </div>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[10px] items-center justify-center pt-[16px] relative size-full">
        <Text10 />
        <Text11 />
        <Button14 />
        <Text12 />
...
function Container4() {
  return (
    <div className="max-w-[1100px] relative shrink-0 w-[1100px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center max-w-[inherit] px-[16px] py-[32px] relative size-full">
        <Container5 />
        <Container14 />
      </div>
    </div>
...
function MainContent1() {
  return (
    <div className="h-[766px] relative shrink-0 w-[1251px]" data-name="Main Content">
...
function Container15() {
  return <div className="flex-[1064.305_0_0] h-0 min-w-px relative" data-name="Container" />;
}
...
function Container3() {
  return (
    <div className="h-[766px] relative shrink-0 w-[1251px]" data-name="Container">
...
function Container2() {
  return (
    <div className="flex-[1251_0_0] h-full min-w-px relative" data-name="Container">
...
function MainContent() {
  return (
    <div className="bg-[#f8fafc] flex-[1252_0_0] h-[766px] min-w-px relative" data-name="Main Content">
...
function Body() {
  return (
    <div className="h-[766px] relative shrink-0 w-full" data-name="Body">
...
function Container21() {
  return (
    <div className="flex-[627.719_0_0] min-h-px relative w-full" data-name="Container">
...
function Button20() {
  return <div className="absolute h-[766px] left-[251px] top-0 w-[16px]" data-name="Button - 사이드바 열기/닫기" />;
}

function Container18() {
  return (
    <div className="bg-white h-[766px] relative shrink-0 w-[259px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Container19 />
        <Container21 />
        <Container27 />
...
function Container17() {
  return (
    <div className="absolute h-[766px] left-0 top-0 w-[260px]" data-name="Container">
...
function Image1() {
  return <div className="absolute left-0 size-[80px] top-0" data-name="Image (딸깍이)" />;
}

function Container32() {
  return (
    <div className="drop-shadow-[0px_4px_4px_rgba(0,0,0,0.15)] relative shrink-0 size-[80px]" data-name="Container">
...
function Button21() {
  return (
    <div className="absolute left-[1416px] top-[670px]" data-name="Button - 고객 지원 채팅">
...
export default function Component() {
  return (
    <div className="bg-[#f8fafc] content-stretch flex flex-col items-start relative size-full" data-name="새 대화 - 딸깍">
      <Body />
      <Container17 />
      <Button21 />
    </div>
