import svgPaths from "./svg-a7yfwo0x7r";
    ...
    <div className="relative shrink-0 w-full" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[#4f7bff] text-[38px] text-center tracking-[-1.9px] whitespace-nowrap">
          <span className="leading-[47.5px]">오디오</span>
...
function Paragraph() {
  return (
    <div className="h-[38px] relative shrink-0 w-[368.797px]" data-name="Paragraph">
...
function Container6() {
  return (
    <div className="h-[126px] max-w-[768px] relative shrink-0 w-[368.797px]" data-name="Container">
...
function Button7() {
  return (
    <div className="bg-[#f1f6fa] h-full relative rounded-[16777200px] shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center px-[16px] py-[6px] relative size-full">
          <p className="[word-break:break-word] font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#737373] text-[14px] text-center whitespace-nowrap">음악</p>
        </div>
      </div>
    </div>
  );
...
function Button8() {
  return (
    <div className="bg-[#f1f6fa] h-full relative rounded-[16777200px] shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center px-[16px] py-[6px] relative size-full">
          <p className="[word-break:break-word] font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#737373] text-[14px] text-center whitespace-nowrap">팟캐스트</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 size-[48px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="Icon" opacity="0.2">
          <path d={svgPaths.pd9d76f0} id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
          <path d={svgPaths.p3f9d8cc0} id="Vector_2" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0" data-name="Paragraph:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[4px] relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#737373] text-[14px] whitespace-nowrap">해당 카테고리의 템플릿을 준비하고 있습니다.</p>
      </div>
    </div>
  );
}
...
function Container17() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center py-[64px] relative size-full">
        <IconMargin />
        <p className="[word-break:break-word] font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[28px] relative shrink-0 text-[#737373] text-[18px] whitespace-nowrap">준비 중</p>
        <ParagraphMargin />
      </div>
    </div>
  );
