import svgPaths from "./svg-hg5i11bmgy";
...
import imgImageDocument from "./b85110a2966e08a30319ecf5e6a9028902a83c36.png";
...
function Link11() {
  return (
    <div className="h-[20px] relative shrink-0 w-[199px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#155dfc] text-[14px] tracking-[-0.35px] whitespace-nowrap">주택임대차 표준계약서 작성 안내</p>
      </div>
    </div>
  );
}
...
function ListItem3() {
  return (
    <div className="bg-[#f1f5f9] h-[32px] relative rounded-[14px] shrink-0 w-[243px]" data-name="List Item">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip pl-[12px] pr-[32px] py-[8px] relative rounded-[inherit] size-full">
        <Link11 />
      </div>
    </div>
...
function ImageDocument() {
  return (
    <div className="h-[422.797px] relative rounded-[4px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Image (주택임대차 표준계약서, 스타일: 비즈니스, 카테고리: document)">
...
function Text8() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[16px] relative shrink-0 text-[#0a0a0a] text-[12px] w-[224px]">주택임대차 표준계약서, 스타일: 비즈니스, 카테고리: document</p>
      </div>
    </div>
  );
}
...
function Icon9() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_19_2554)" id="Icon">
...
function Container28() {
  return (
    <div className="absolute left-0 opacity-46 top-[559.3px] w-[784px]" data-name="Container">
...
function Container22() {
  return (
    <div className="relative shrink-0 w-[784px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start justify-end relative size-full">
        <Container23 />
        <Container28 />
      </div>
    </div>
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon" opacity="0.6">
          <path d="M12 10L8 6L4 10" id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Container33() {
  return <div className="absolute bg-[#dfe6ed] h-0 left-[7px] top-[30px] w-px" data-name="Container" />;
}
...
function Text10() {
  return (
    <div className="absolute h-[17px] left-0 opacity-60 top-[1.5px] w-[97.781px]" data-name="Text">
      <p className="[word-break:break-word] absolute font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[20px] left-0 text-[#737373] text-[14px] top-[-1px] whitespace-nowrap">10개 단계 더 보기</p>
    </div>
  );
}
...
function Container34() {
  return (
    <div className="flex-[97.781_0_0] h-[20px] min-w-px relative" data-name="Container">
...
function Button7() {
  return (
    <div className="absolute content-stretch flex h-[36px] items-start left-0 px-[16px] py-[8px] top-[-8px] w-[778px]" data-name="Button">
      <Container31 />
    </div>
  );
}
...
function Container29() {
  return (
    <div className="relative rounded-[10px] shrink-0 w-[784px]" data-name="Container">
      <div aria-hidden className="absolute border border-[#dfe6ed] border-solid inset-0 pointer-events-none rounded-[10px]" />
  ...
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_19_2548)" id="Icon">
          <path d={svgPaths.p2756bb00} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d="M11.6667 1.16667V3.5" id="Vector_2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d="M12.8333 2.33333H10.5" id="Vector_3" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d={svgPaths.p291dcf00} id="Vector_4" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
        </g>
        <defs>
          <clipPath id="clip0_19_2548">
...
function Text11() {
  return (
    <div className="bg-[rgba(0,0,0,0.1)] relative rounded-[16777200px] shrink-0 size-[24px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Icon11 />
      </div>
    </div>
...
function Container37() {
  return (
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#0a0a0a] text-[14px] whitespace-nowrap">확인이 필요해요</p>
      </div>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[#737373] text-[12px] whitespace-nowrap">주택임대차 표준계약서(doc-33)를 작성하기 위해 아래 항목을 입력해주세요. 입력해주신 내용을 바탕으로 맞춤 계약서를 완성해 드리겠습니다.</p>
      </div>
    </div>
  );
}
...
function Icon12() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_19_2535)" id="Icon">
          <path d={svgPaths.p3179c6f0} id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p2bdb5600} id="Vector_2" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M3.33333 4V6.66667" id="Vector_3" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M12.6667 9.33333V12" id="Vector_4" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M6.66667 1.33333V2.66667" id="Vector_5" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M4.66667 5.33333H2" id="Vector_6" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M14 10.6667H11.3333" id="Vector_7" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M7.33333 2H6" id="Vector_8" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
        <defs>
...
function Button8() {
  return (
    <div className="bg-[#f8fafc] drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] h-[32px] relative rounded-[8px] shrink-0" data-name="Button">
      <div aria-hidden className="absolute border border-[#dfe6ed] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[6px] items-center justify-center px-[11px] py-px relative size-full">
        <Icon12 />
        <p className="[word-break:break-word] font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#0a0a0a] text-[12px] text-center whitespace-nowrap">자동 채우기</p>
      </div>
    </div>
  );
}
...
function Container40() {
  return (
    <div className="h-[44px] relative shrink-0 w-[750px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-end pt-[12px] relative size-full">
        <Button8 />
      </div>
    </div>
  );
...
function Label() {
  return (
    <div className="relative shrink-0 w-full" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#0a0a0a] text-[12px] whitespace-nowrap">계약 당사자(갑)</p>
      </div>
    </div>
  );
}
...
function TextInput() {
  return (
    <div className="bg-[rgba(255,255,255,0)] h-[36px] relative rounded-[8px] shrink-0 w-[369px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center overflow-clip px-[13px] py-[5px] relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#737373] text-[14px] w-full">계약 당사자(갑)</p>
      </div>
      <div aria-hidden className="absolute border border-[#dfe6ed] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
    </div>
  );
}
...
function Label1() {
  return (
    <div className="relative shrink-0 w-full" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#0a0a0a] text-[12px] whitespace-nowrap">계약 당사자(을)</p>
      </div>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="bg-[rgba(255,255,255,0)] h-[36px] relative rounded-[8px] shrink-0 w-[369px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center overflow-clip px-[13px] py-[5px] relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#737373] text-[14px] w-full">계약 당사자(을)</p>
      </div>
      <div aria-hidden className="absolute border border-[#dfe6ed] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
    </div>
  );
...
function Label2() {
  return (
    <div className="relative shrink-0 w-full" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#0a0a0a] text-[12px] whitespace-nowrap">계약 내용 또는 품목</p>
      </div>
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="bg-[rgba(255,255,255,0)] h-[36px] relative rounded-[8px] shrink-0 w-[369px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center overflow-clip px-[13px] py-[5px] relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#737373] text-[14px] w-full">계약 내용 또는 품목</p>
      </div>
      <div aria-hidden className="absolute border border-[#dfe6ed] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
    </div>
  );
...
function Label3() {
  return (
    <div className="relative shrink-0 w-full" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#0a0a0a] text-[12px] whitespace-nowrap">계약 기간</p>
      </div>
    </div>
  );
}
...
function TextInput3() {
  return (
    <div className="bg-[rgba(255,255,255,0)] h-[36px] relative rounded-[8px] shrink-0 w-[369px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center overflow-clip px-[13px] py-[5px] relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#737373] text-[14px] w-full">계약 기간</p>
      </div>
      <div aria-hidden className="absolute border border-[#dfe6ed] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
    </div>
  );
...
function Label4() {
  return (
    <div className="relative shrink-0 w-full" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#0a0a0a] text-[12px] whitespace-nowrap">계약 금액</p>
      </div>
    </div>
  );
}
...
function TextInput4() {
  return (
    <div className="bg-[rgba(255,255,255,0)] h-[36px] relative rounded-[8px] shrink-0 w-[369px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center overflow-clip px-[13px] py-[5px] relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#737373] text-[14px] w-full">계약 금액</p>
      </div>
      <div aria-hidden className="absolute border border-[#dfe6ed] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
    </div>
  );
...
function Container41() {
  return (
    <div className="gap-x-[12px] gap-y-[12px] grid grid-cols-[__369px_369px] grid-rows-[___58px_58px_58px] h-[198px] relative shrink-0 w-full" data-name="Container">
      <Container42 />
      <Container43 />
      <Container44 />
      <Container45 />
...
function Container38() {
  return (
    <div className="h-[278px] max-h-[427.3399963378906px] relative shrink-0 w-[750px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start max-h-[inherit] overflow-clip pt-[12px] relative rounded-[inherit] size-full">
        <Container39 />
        <Container40 />
        <ContainerMargin2 />
      </div>
...
function Icon13() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_19_2529)" id="Icon">
          <path d={svgPaths.p15ab3e60} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
...
function Button9() {
  return (
    <div className="bg-[#3b63f6] content-stretch flex gap-[8px] h-[48px] items-center justify-center opacity-50 px-[12px] py-[8px] relative rounded-[14px] shrink-0 w-[750px]" data-name="Button">
      <Icon13 />
      <p className="[word-break:break-word] font-['Pretendard_Variable:Bold',sans-serif] font-bold leading-[20px] relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">생성</p>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="bg-[rgba(248,250,252,0.8)] max-w-[816px] relative rounded-[18px] shrink-0 w-[784px]" data-name="Container">
      <div aria-hidden className="absolute border border-[#dfe6ed] border-solid inset-0 pointer-events-none rounded-[18px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start max-w-[inherit] p-[17px] relative size-full">
        <Container36 />
        <Container38 />
        <ContainerMargin3 />
      </div>
...
function Container55() {
  return (
    <div className="absolute h-[20px] left-0 top-[2px] w-[179px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#0a0a0a] text-[14px] whitespace-nowrap">주택임대차 표준계약서 작성 안내</p>
      </div>
    </div>
  );
}
...
function Text14() {
  return (
    <div className="h-[20px] relative shrink-0 w-[179.383px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
        <Container54 />
      </div>
    </div>
...
function Container53() {
  return (
    <div className="flex-[1472.305_0_0] min-w-px relative" data-name="Container">
...
export default function Component() {
  return (
    <div className="bg-[#f8fafc] relative size-full" data-name="문서 워크스페이스">
      <Container />
      <Body />
      <Button17 />
    </div>
